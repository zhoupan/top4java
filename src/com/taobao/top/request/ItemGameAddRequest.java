 ...
 */
public class ItemGameAddRequest implements TopUploadRequest {
	...
	public void setVerticalImage(FileItem verticalImage) {
		this.verticalImage = verticalImage;
	}
	public void setVerticalImageId(Long verticalImageId) {
	...
	public Map<String, String> getTextParams() {
		...
		params.put("game_type", this.gameType);
		...
		params.put("vertical_ids", this.verticalIds);
		params.put("vertical_image_id", this.verticalImageId);
		params.put("vertical_values", this.verticalValues);
		return params;
	}

	public Map<String, FileItem> getFileParams() {
		Map<String, FileItem> params = new HashMap<String, FileItem>();
		params.put("vertical_image", this.verticalImage);
		return params;
	}
