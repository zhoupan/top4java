 ...
 */
public class ItemVipUpdateRequest implements TopUploadRequest {
	...
	public Map<String, String> getTextParams() {
		...
		params.put("is_replace_sku", this.isReplaceSku);
		...
		params.put("second_kill", this.secondKill);
